module.exports = {
	...
	'Room form check errors visible' : function (roomsErrors) {
        roomsErrors
			...
			.verify.containsText( '#invalid-name', 'Room name must be longer than 3 characters')
			.verify.containsText( '#invalid-location', 'Location must be longer than 3 characters')
    ...
    'Conference form check errors visible': function(conferencesErrors) {
        conferencesErrors
            ...
            .verify.containsText( '#invalid-roomId', '')
            .verify.containsText( '#invalid-name', 'Conference name must be longer than 3 characters')
    ...
    'Participants form check errors visible': function(participantsErrors) {
        participantsErrors
            ...
            .verify.containsText( '#invalid-fullName', 'Full name must be longer than 3 characters')
