        ...
        <form>
          ...
          <div className="form-group row">
            ...
            <div className="col-10">
              <input
                className={`form-control ${
                  this.state.locationError ? "is-invalid" : ""
                }`}
                type="text"
                name="location"
              ...
              />
              <div id="invalid-location" className="invalid-feedback">
                {this.state.locationError}
              </div>
            </div>
          </div>
          <div className="form-group row">
            ...
            <div className="col-10">
              <input
                className={`form-control ${
                  this.state.maxSeatsError ? "is-invalid" : ""
                }`}
                type="number"
                name="maxSeats"
                placeholder="100"
                ...
                onBlur={this.validateMaxSeats}
              />
              <div id="invalid-maxSeats" className="invalid-feedback">
                {this.state.maxSeatsError}
              </div>
            </div>
          </div>
