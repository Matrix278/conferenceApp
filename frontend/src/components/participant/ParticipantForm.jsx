    ...
    handleSubmit(event) {
        ...
        if(this.state.conferenceId !== "" && this.state.fullName !== "" && this.state.birthDate !== ""){
            if(this.state.conferenceIdError === "" && this.state.fullNameError === "" && this.state.birthDateError === "") {
                ...
                this.props.createParticipant(newParticipant, this.props.loadAllConferences);
            }
        }
    }
            ...
            <div>
                ...
                <form>
					...
					<div className="form-group row">
						...
						<div className="col-10">
							<input className={`form-control ${this.state.birthDateError ? 'is-invalid' : ''}`} type="date" name="birthDate" id="example-date-input" min="1800-09-31" max="2000-12-31" value={this.state.birthDate} onChange={this.handleBirthDateChange} onBlur={this.validateBirthDate}/>
