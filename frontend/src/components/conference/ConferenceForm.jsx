                ...
                <form>
                    <div className="form-group row">
                        ...
                        <div className="col-10">
                            ...
                            {
                                this.state.loadedRooms.map(
                                    loadedRoom =>
                                    <option key={loadedRoom.id} value={loadedRoom.id}>{loadedRoom.id} - {loadedRoom.name}, Location: {loadedRoom.location} (Max seats: {loadedRoom.maxSeats})</option>
                                )
                            }
                            </select>
